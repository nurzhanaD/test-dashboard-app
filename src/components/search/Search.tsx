...
function Search(props: Props) {
    return (
        <div className="search">
            ...
            <input type="text"  className='search__input' onChange={props.change} value={props.value}/>
            <div className="search__amount">{props.testComponentAmount} tests</div>
        </div>
    )
}
